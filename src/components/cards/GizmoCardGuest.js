...
export const GizmoCardGuest = ({
  ...
  return (
    <>
      <div className=" group md:w-72 w-72 shadow-lg transition duration-300 border-gray-300 md:hover:scale-105 border-1 shadow-s shadow-gray-400 dark:bg-gray-800 dark:border-gray-700 bg-white text-left rounded-lg relative">
        {variant === "publicCard" ? (
          <>
            <img
